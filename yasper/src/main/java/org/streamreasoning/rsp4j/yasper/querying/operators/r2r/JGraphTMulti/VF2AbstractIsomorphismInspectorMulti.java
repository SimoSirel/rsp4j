 ...
 */
public abstract class VF2AbstractIsomorphismInspectorMulti<V, E>
        implements
     ...
     */
    public VF2AbstractIsomorphismInspectorMulti(
...
//        }
        ...
        this.ordering1 = new MultiGraphOrdering<>(graph1, true, cacheEdges);
        this.ordering2 = new MultiGraphOrdering<>(graph2, true, cacheEdges);
    }
     ...
     * @param graph2 the second graph
     */
    public VF2AbstractIsomorphismInspectorMulti(Graph<V, E> graph1, Graph<V, E> graph2) {
