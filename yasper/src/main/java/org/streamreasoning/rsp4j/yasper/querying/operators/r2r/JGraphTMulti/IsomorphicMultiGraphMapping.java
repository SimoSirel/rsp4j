 ...
 */
public class IsomorphicMultiGraphMapping<V, E>
        implements
        GraphMapping<V, E> {
     ...
     */
    public IsomorphicMultiGraphMapping(
            MultiGraphOrdering<V, E> g1, MultiGraphOrdering<V, E> g2, int[] core1, int[] core2) {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || getClass() != o.getClass())
            return false;
        IsomorphicMultiGraphMapping<?, ?> that = (IsomorphicMultiGraphMapping<?, ?>) o;
     ...
     */
    public IsomorphicMultiGraphMapping<V, E> compose(IsomorphicMultiGraphMapping<V, E> otherMapping) {
        ...
        return new IsomorphicMultiGraphMapping<>(fMap, bMap, graph1, otherMapping.graph2);
    }
     ...
     */
    public static <V, E> IsomorphicMultiGraphMapping<V, E> identity(Graph<V, E> graph) {
        ...
        return new IsomorphicMultiGraphMapping<>(fMap, bMap, graph, graph);
    }
}
