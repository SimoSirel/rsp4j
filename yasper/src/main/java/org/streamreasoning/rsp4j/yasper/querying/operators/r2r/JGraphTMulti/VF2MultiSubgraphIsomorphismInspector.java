 ...
 */
public class VF2MultiSubgraphIsomorphismInspector<V, E>
        extends
        VF2AbstractIsomorphismInspectorMulti<V, E> {
     ...
     */
    public VF2MultiSubgraphIsomorphismInspector(
     ...
     * @param graph2 the second graph (possible induced subgraph of graph1)
     */
    public VF2MultiSubgraphIsomorphismInspector(Graph<V, E> graph1, Graph<V, E> graph2) {
        super(graph1, graph2, true);
    }

    @Override
    public Iterator<GraphMapping<V, E>> getMappings() {
        return new VF2MultiSubgraphMappingIterator<V, E>(
