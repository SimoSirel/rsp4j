...
final class MultiGraphOrdering<V, E>
{
    ...
    public MultiGraphOrdering(Graph<V, E> graph, boolean orderByDegree, boolean cacheEdges)
    {
        this.graph = graph;
     ...
     * @param graph the graph to be ordered
     */
    public MultiGraphOrdering(Graph<V, E> graph)
    {
