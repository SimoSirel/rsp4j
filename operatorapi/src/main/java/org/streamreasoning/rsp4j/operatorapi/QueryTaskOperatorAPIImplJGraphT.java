...
public class QueryTaskOperatorAPIImplJGraphT extends TaskOperatorAPIImpl<Graph<IRI, PredicateEdge>, Graph<IRI, PredicateEdge>, Binding, Binding> {

    public QueryTaskOperatorAPIImplJGraphT(TaskBuilder<Graph<IRI, PredicateEdge>, Graph<IRI, PredicateEdge>, Binding, Binding> builder) {
        super(builder);
    }

    public static class QueryTaskBuilder extends TaskBuilder<Graph<IRI, PredicateEdge>, Graph<IRI, PredicateEdge>, Binding, Binding> {

        public QueryTaskBuilder() {
            super();
        }

        public QueryTaskBuilder fromQuery(ContinuousQuery<Graph<IRI, PredicateEdge>, Graph<IRI, PredicateEdge>, Binding, Binding> query) {
            // add S2R
            ...
            query.getWindowMap().entrySet().stream()
                    .forEach(
                            entry -> {
                                StreamToRelationOp<Graph<IRI, PredicateEdge>, Graph<IRI, PredicateEdge>> s2r =
